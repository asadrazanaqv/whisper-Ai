...
const TextTranslate = () => {
  ...
  const translateText = async () => {
    ...
    setLoading(true);
    const prompt = `Translate the following text: "${text}" into ${language}.`;
    console.log("Prompt:", prompt); // Log prompt before the request

    console.log("Request Payload:", { prompt, currentModel });
